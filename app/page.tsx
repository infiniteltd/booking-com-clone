...
export default function Home() {
  return (
    <main className="bg-[#013894]">
      ...
      <section className="m-4 mt-0 -mb-14 px-2 lg:px-4 rounded-xl">
        <SearchForm />
      </section>

      <section className="mx-auto max-w-7xl mt-10 p-6 bg-white round-t-lg">
        <div className="pt-5">
        ...
        <div className="flex space-x-4 py-5 overflow-scroll">
